...
from cmpapp.forms import ProveedorForm, ComprasEncForm
...
class ProveedorView(SinPrivilegios, generic.ListView):
    model = Proveedor
    template_name = "cmpapp/proveedor_list.html"
    context_object_name = "obj"
    permission_required = "cmpapp.view_proveedor"
    
class ProveedorNew(SuccessMessageMixin, SinPrivilegios,  generic.CreateView):
    model = Proveedor
    template_name = "cmpapp/proveedor_form.html"
    context_object_name = "obj"
    form_class = ProveedorForm
    success_url = reverse_lazy("cmp:proveedor_list")
    success_message = "Proveedor Creado Satistactoriamente"
    permission_required = "cmpapp.add_proveedor"
...
class ProveedorEdit(SuccessMessageMixin, SinPrivilegios, generic.UpdateView):
    permission_required = "cmpapp.change_proveedor"
    model = Proveedor
    template_name = "cmpapp/proveedor_form.html"
    context_object_name = "obj"
    form_class = ProveedorForm
    success_url = reverse_lazy("cmp:proveedor_list")
    success_message = "Proveedor Actualizado Satistactoriamente"
...
@permission_required("invapp.change_proveedor", login_url="/login/")
def proveedorInactivar(request, id):
    template_name ='cmpapp/inactivar_prv.html'
    contexto={}
...
class ComprasView(SinPrivilegios, generic.ListView):
    model = ComprasEnc
    template_name = "cmpapp/compras_list.html"
    context_object_name = "obj"
    permission_required = "cmpapp.view_comprasenc"


@login_required(login_url="/login/")
@permission_required("cmpapp.view_comprasenc", login_url="base:sin_privilegios")
def compras(request, compra_id=None):
    template_name = 'cmpapp/compras.html'    
...
class CompraDetDelete(SinPrivilegios, generic.DeleteView):
    permission_required = "cmpapp.delete_comprasdet"
    model = ComprasDet
    template_name = "cmpapp/compras_det_del.html"
    context_object_name = 'obj'
