...
import invapp.views as invapp
from invapp.models import Producto


class ClienteView(SinPrivilegios, generic.ListView):
    model = Cliente
    template_name = "facapp/cliente_list.html"
    context_object_name = "obj"
    permission_required = "facapp.view_cliente" # se usa en la plantilla base
...
class ClienteNew(VistaBaseCreate):
    model = Cliente
    template_name = "facapp/cliente_form.html"
    form_class = ClienteForm
    success_url = reverse_lazy("fac:cliente_list")
    permission_required = "facapp.add_cliente"
...
class ClienteEdit(VistaBaseEdit):
    ...
    form_class = ClienteForm
    success_url = reverse_lazy("fac:cliente_list")
    permission_required = "facapp.change_cliente"


@login_required(login_url="/login/")
@permission_required("facapp.change_cliente", login_url="/login/")
...
class FacturaView(SinPrivilegios, generic.ListView):
    model = FacturaEnc
    template_name = "facapp/factura_list.html"
    context_object_name = "obj"
    permission_required = "facapp.view_facturaenc"


@login_required(login_url='/login/')
@permission_required('facapp.change_facturaenc', login_url='base:sin_privilegios')
def facturas(request, id=None):
    template_name = 'facapp/facturas.html'
...
class ProductoView(invapp.ProductoView):
    template_name = "facapp/buscar_producto.html"


def borrar_detalle_factura(request, id):
    template_name = "facapp/factura_borrar_detalle.html"
    ...
    if request.method == "POST":
        ...
        if user.is_superuser or user.has_perm("facapp.sup_caja_facturadet"):
            det.id = None
